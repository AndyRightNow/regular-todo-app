! function (t, e) {
  ...
  return function (t) {
    ...
    var r = n(1),
      ...
      a = o.Parser,
      s = o.Lexer;
    r.browser && (n(24), n(27), n(28), o.dom = n(13)), o.env = r, o.util = n(2), o.parse = function (t, e) {
    ...
    (function (e, r) {
      ...
      o.noop = function () {}, o.uid = function () {
        ...
        for (var r = [], i = e || 0, o = n || t.length; o > i; i++) r.push(t[i]);
        return r
      }, o.typeOf = function (t) {
      ...
      o.convertEntity = function (t) {
        ...
        if (Array.isArray(t)) {
          for (var e = [], n = 0, r = t.length; r > n; n++) e[n] = t[n];
          return e
        }
        var e = {};
      ...
      o.camelCase = function (t) {
        ...
        return function () {
          var u = +new Date,
            c = e - (u - a);
          return n = this, r = arguments, 0 >= c || c > e ? (clearTimeout(o), o = null, a = u, i = t.apply(n, r), n = r = null) : o || (o = setTimeout(s, c)), i
        }
      }, o.escape = function () {
        var t = /&/g,
          e = /</g,
            ...
            if (r) {
              ...
              i.forEach(function (t) {
                ...
                i && i.length && (t.param = {}, i.forEach(function (e) {
                  e in a && (t.param[e] = void 0 === a[e] ? !0 : a[e], o.removeOne(n, function (t) {
                    return t.name === e
                  }))
                }))
              }), n.sort(function (t, e) {
    ...
    function i() {
      p && l && (p = !1, l.length ? h = l.concat(h) : d = -1, h.length && o())
    }
    ...
    f.nextTick = function (t) {
      ...
      h.push(new a(t, e)), 1 !== h.length || p || n(o)
    }, a.prototype.run = function () {
      this.fun.apply(null, this.array)
    }, f.title = "browser", f.browser = !0, f.env = {}, f.argv = [], f.version = "", f.versions = {}, f.on = s, f.addListener = s, f.once = s, f.off = s, f.removeListener = s, f.removeAllListeners = s, f.emit = s, f.binding = function (t) {
    ...
    var d = n(20),
      ...
      y = function (t, e) {
        ...
        var l, h = this._eventListeners || [];
        t.events && (l = s.normListener(t.events), l.length && (h = h.concat(l)), delete t.events), s.extend(this, t, !0), this.$parent && this.$parent._append(this), this._children = [], this.$refs = {}, a = this.template, "string" == typeof a && a.length < 16 && (i = f.find(a)) && (a = i.innerHTML), a && a.nodeType && (a = a.innerHTML), "string" == typeof a && (a = new o(a).parse(), u ? this.constructor.prototype.template = a : delete this.template), this.computed = x(this.computed), this.$root = this.$root || this, h && h.length && h.forEach(function (t) {
        ...
        this._body = null, p && p.ast && p.ast.length && (this.$body = s.getCompileFn(p.ast, p.ctx, {
          ...
          namespace: e.namespace
        }), c.node(this)), this.$parent || this.$update(), this.$ready = !0, this.$emit("$init"), this.init && this.init(this.data), this.$emit("$afterInit"), r.isRunning = n, this.devtools && this.devtools.emit("init", this)
      },
      E = window.__REGULAR_DEVTOOLS_GLOBAL_HOOK__;
    E && (y.prototype.devtools = E), l && (l.Regular = y), s.extend(y, {
      _directives: {
        __regexp__: []
      },
      _plugins: {},
      ...
      __after__: function (t, e) {
        ...
        if (this.__after__ = t.__after__, e.name && y.component(e.name, this), n = e.template) {
          var r, i;
          "string" == typeof n && n.length < 16 && (r = f.find(n)) && (n = r), n && n.nodeType && ((i = f.attr(n, "name")) && y.component(i, this), n = n.innerHTML), "string" == typeof n && (this.prototype.template = a.PRECOMPILE ? new o(n).parse() : n)
        }
      ...
      directive: function (t, e) {
        if (t) {
          ...
          if ("string" === n) {
            if (i = o[t]) return i;
            for (var a = o.__regexp__, s = 0, u = a.length; u > s; s++) {
              i = a[s];
      ...
      config: function (t, e) {
        var n = !1;
        if ("object" == typeof t)
          for (var r in t)("END" === r || "BEGIN" === r) && (n = !0), a[r] = t[r];
        n && i.setup()
      },
      ...
      config: function () {},
      destroy: function () {
        this.$emit("$destroy"), this._watchers = null, this.group && this.group.destroy(!0), this.group = null, this.parentNode = null, this._children = null, this.$root = null, this._handles = null, this.$refs = null;
        var t = this.$parent;
        if (t && t._children) {
          var e = t._children.indexOf(this);
          t._children.splice(e, 1)
        }
        this.$parent = null, this.devtools && this.devtools.emit("destroy", this)
      },
      ...
      $bind: function (t, e, n) {
        ...
        if ("expression" === e.type || "string" === r) this._bind(t, e, n);
          ...
          for (var i = 0, o = e.length; o > i; i++) this._bind(t, e[i]);
        else if ("object" === r)
      ...
      _handleEvent: function (t, e, n, r) {
        var i, o = this.constructor,
          a = "function" != typeof n ? s.handleEvent.call(this, n, e) : n,
          u = o.event(e);
        return u ? i = u.call(this, t, a, r) : f.on(t, e, a), u ? i : function () {
          f.off(t, e, a)
        }
      },
      _touchExpr: function (t) {
        ...
        if (e = t.get, e || (e = t.get = new Function(s.ctxName, s.extName, s.prefix + "return (" + t.body + ")"), t.body = null), r.get = n ? function (t) {
            return e(t, n)
          } : e, t.setbody && !t.set) {
          var i = t.setbody,
            o = t.filters,
            a = this;
          o && s.some(o, function (t) {
            return !a._f_(t).set
    ...
    var x = function () {
      ...
      return function (n) {
        if (n) {
          var r, i, o, a = {};
          for (var s in n) r = n[s], o = typeof r, "expression" !== r.type ? "string" === o ? a[s] = m.expression(r) : (i = a[s] = {
            type: "expression"
          }, "function" === o ? i.get = t(r) : (r.get && (i.get = t(r.get)), r.set && (i.set = e(r.set)))) : a[s] = r;
          return a
        }
      }
    }()
    ...
    function o(t) {
      for (var e, n, r = {}, i = 0, o = t.length; o > i; i++) e = t[i], n = e[2] || "INIT", (r[n] || (r[n] = {
        rules: [],
        links: []
      })).rules.push(e);
      return a(r)
    ...
    function a(t) {
      ...
      for (var l in t) {
        ...
        for (var p = 0, d = i.length; d > p; p++) f = i[p], s = f[0], a = f[1], "string" == typeof a && (a = r(a)), "regexp" === c.typeOf(s) && (s = s.toString().slice(1, -1)), s = s.replace(/\{(\w+)\}/g, e), u = c.findSubCapture(s) + 1, n.links.push([n.curIndex, u, a]), n.curIndex += u, o.push(s);
    ...
    v.lex = function (t) {
      ...
      for (var r, i = e.links, o = !1, a = i.length, s = 0; a > s; s++) {
        var u = i[s],
          c = u[2],
          f = u[0];
        if (d(t[f])) {
          o = !0, c && (r = c.apply(this, t.slice(f, f + u[1])), r && (r.pos = this.index));
          break
        }
      }
    ...
    function r(t, e) {
      e = e || {}, this.input = t, this.tokens = new u(t, e).lex(), this.pos = 0, this.length = this.tokens.length
    }
    ...
    var o = n(2),
      ...
      f = o.ctxName,
      l = o.extName,
      h = o.makePredicate("STRING IDENT NUMBER"),
      p = o.makePredicate("true false undefined null this Array Date JSON Math NaN RegExp decodeURI decodeURIComponent encodeURI encodeURIComponent parseFloat parseInt Object"),
      d = r.prototype;
    d.parse = function () {
      this.pos = 0;
      var t = this.program();
      ...
      var t, e, n, r;
      return t = this.match("TAG_OPEN").value, e = this.attrs(), r = this.eat("/"), this.match(">"), r || o.isVoidTag(t) || (n = this.program(), this.eat("TAG_CLOSE", t) || this.error("expect </" + t + "> gotno matched closeTag")), s.element(t, e, n)
    }, d.xentity = function (t) {
      var e, n, r = t.value;
      if ("NAME" === t.type) {
        if (~r.indexOf(".")) {
          var i = r.split(".");
        ...
        return this.eat("=") && (e = this.attvalue(n)), s.attribute(r, e, n)
      }
      ...
      switch (e.type) {
        ...
        case "STRING":
          ...
          if (~n.indexOf(a.BEGIN) && ~n.indexOf(a.END) && "cmpl" !== t) {
            ...
            }), u = "[" + u.join(",") + "].join('')", n = s.expression(u, null, i)
          }
          return n;
        case "EXPR_OPEN":
          return this.interplation();
      ...
      var e = this.expression(),
        ...
        o = t ? "attrs" : "statement";
      this.match("END");
      for (var a, u; !(u = this.eat("CLOSE"));)
        if (a = this.ll(), "OPEN" === a.type) switch (a.value) {
          case "else":
            i = r, this.next(), this.match("END");
            break;
          case "elseif":
            return this.next(), r.push(this["if"](t)), s["if"](e, n, r);
          default:
            i.push(this[o](!0))
        } else i.push(this[o](!0));
      return "if" !== u.value && this.error("Unmatched if directive"), s["if"](e, n, r)
    }, d.list = function () {
      var t, e, n, r = this.expression(),
        i = [],
        o = [],
        a = i;
      for (this.match("IDENT", "as"), t = this.match("IDENT").value, this.eat("IDENT", "by") && (this.eat("IDENT", t + "_index") ? n = !0 : (n = this.expression(), n.constant && (n = !0))), this.match("END"); !(e = this.eat("CLOSE"));) this.eat("OPEN", "else") ? (a = o, this.match("END")) : a.push(this.statement());
      return "list" !== e.value && this.error("expect list got /" + e.value + " ", e.pos), s.list(r, t, i, o, n)
    }, d.expression = function () {
      var t;
      ...
      var t = this.filter(),
        e = t.get || t,
        n = t.set;
      return s.expression(e, n, !this.depend.length, t.filters)
    }, d.filter = function () {
      ...
      if (s) {
        ...
        do {
          ...
          h = c + " = " + f + "._f_('" + p + "' ).get.call( " + o.ctxName + "," + c, h += this.eat(":") ? ", " + this.arguments("|").join(",") + ");" : ");", u.push(h), l && (t.push(p), e.unshift(h.replace(" ).get.call", " ).set.call")))
        } while (s = this.eat("|"));
        u.push("return " + c), e && e.push("return " + c), r = n + u.join("") + "})(" + a.get + ")", e && (l = l.replace(o.setName, n + e.join("") + "})(" + o.setName + ")"));
        var d = i(r, l);
    ...
    }, d.member = function (t, e, n, r) {
      var i, a, s, u = !1;
      if (t) "string" == typeof e && h(e) ? n.push(e) : (n && n.length && this.depend.push(n), n = null);
      else {
        a = this.primary();
        var p = typeof a;
        "string" === p ? (n = [], n.push(a), e = a, s = l + "." + a, t = f + "._sg_('" + a + "', " + c + ", " + l + ")", u = !0) : "this" === a.get ? (t = f, n = ["this"]) : (n = null, t = a.get)
      }
      if (i = this.eat(["[", ".", "("])) switch (i.type) {
        case ".":
          var d = this.match("IDENT").value;
          return r = t, "(" !== this.la() ? t = f + "._sg_('" + d + "', " + t + ")" : t += "['" + d + "']", this.member(t, d, n, r);
        case "[":
          return a = this.assign(), r = t, "(" !== this.la() ? t = f + "._sg_(" + a.get + ", " + t + ")" : t += "[" + a.get + "]", this.match("]"), this.member(t, a, n, r);
        case "(":
      ...
      return e && (m.set = f + "._ss_(" + (e.get ? e.get : "'" + e + "'") + "," + o.setName + "," + (r ? r : o.varName) + ", '=', " + (u ? 1 : 0) + ")"), m
    }, d.arguments = function (t) {
      t = t || ")";
      var e = [];
      ...
      switch (t.type) {
        ...
        case "IDENT":
          return this.next(), p(t.value) ? i(t.value) : t.value;
        default:
    ...
    function i(t, e, n) {
      for (var i in e) e.hasOwnProperty(i) && (u[i] && u[i](e[i], t, n), t[i] = s(e[i]) && s(n[i]) && a.test(e[i]) ? r(i, e[i], n) : e[i])
    }
    var o = n(2),
      a = /xy/.test(function () {
        "xy"
    ...
    u.body = document.body, u.doc = document, u.tNode = h, h.addEventListener ? (a = function (t, e, n) {
      ...
      if (n = n || "bottom", t) {
        if (Array.isArray(t)) {
          var r = t;
          t = u.fragment();
          for (var i = 0, o = r.length; o > i; i++) t.appendChild(r[i])
        }
        var a, s;
        switch (n) {
          case "bottom":
    ...
    u.attr = function (t, e, n) {
      ...
      var t = {};
      return u.msie && u.msie < 9 ? (t[1] = "innerText", t[3] = "nodeValue") : t[1] = t[3] = "textContent",
        function (e, n) {
          var r = t[e.nodeType];
      ...
      if ("object" == typeof e && e)
        for (var i in e) e.hasOwnProperty(i) && u.css(t, i, e[i]);
      else {
        if ("undefined" == typeof n) {
          var o;
          return u.msie <= 8 && (o = t.currentStyle && t.currentStyle[e], "" === o && (o = "auto")), o = o || t.style[e], u.msie <= 8 && (o = "" === o ? void 0 : o), o
        }
        e = r(e), e && (t.style[e] = n)
      }
    }, u.addClass = function (t, e) {
      var n = t.className || ""; - 1 === (" " + n + " ").indexOf(" " + e + " ") && (t.className = n ? n + " " + e : e)
    ...
    var m = /^(?:click|dblclick|contextmenu|DOMMouseScroll|mouse(?:\w+))$/,
      g = document;
    g = g.compatMode && "CSS1Compat" !== g.compatMode ? g.body : g.documentElement, f.extend(o.prototype, {
      stop: function () {
    ...
    d.list = function (t, e) {
      function n(n, r, i, a) {
        for (var c = n; r > c; c++) {
          ...
          p.data = h;
          var d = s.last(_.get(c));
          d.parentNode && u.inject(s.node(p), d, "after"), N.splice(c + 1, 0, p)
        }
      }

      function o(t, e, n, r) {
        t[w] = e, r ? (t[b] = n, t[$] = r[n]) : (t[$] = n, t[b] = null)
      }
        ...
        if (i || 0 === u && 0 === e.length || (i = a(t, e, !0)), i && i.length) {
          for (var c = 0; c < i.length; c++) {
            var l = i[c],
              ...
              v = p.length;
            if (S && v && d) {
              for (var g = Math.min(v, d), y = 0; g > y;) m(t[h], h) !== m(p[0], h) && (r(h, 1, N), n(h, h + 1, t, o)), p.shift(), d--, h++, y++;
              v = p.length
            }
            f(s, h, t, o), r(h, v, N), n(h, h + d, t, o), s = h + d - v, s = 0 > s ? 0 : s
          }
          if (u > s)
            for (var c = s; u > c; c++) {
              var E = _.get(c + 1);
      ...
      function p(t, e, i) {
        var o = t.length,
          a = e.length,
          s = Math.min(o, a);
        f(0, s, t, i), a > o ? r(o, a - o, N) : o > a && n(a, o, t, i)
      }
      ...
      function v(t, n, r) {
        ...
        if ("object" === a && (o = t), S === !0 ? p(f, d, o) : h(f, d, r, o), !v && A && A.length) {
          ...
          N.push(w), y.parentNode && u.inject(s.node(w), y, "after")
        }
      }
      var m, g, y = (d.Regular, document.createComment("Regular list")),
        E = e.namespace,
        x = e.extra,
        T = this,
        _ = new c([y]),
        ...
        A = t.alternate,
        S = t.track;
      return S && S !== !0 && (S = this._touchExpr(S), g = l.createObject(x), m = function (t, e) {
        return g[$] = t, g[w] = e, S.get(T, g)
      ...
      if (r) {
        ...
        this.$watch(r, function (t) {
          var r = s.get(1),
            c = typeof t;
          r && (r.destroy(!0), s.children.pop()), t && (s.push(n = "function" === c ? t() : u.$compile("object" !== c ? String(t) : t, {
            record: !0,
            outer: e.outer,
            namespace: o,
            extra: a
    ...
    d["if"] = function (t, e) {
      ...
      var n, r, f = document.createComment("Regular if" + v++),
        l = new c;
      l.push(f);
      var h = null,
        d = e.namespace,
        a = function (a, c) {
          var p = !!a;
          p !== h && (h = p, l.children[1] && (l.children[1].destroy(!0), l.children.pop()), p ? t.consequent && t.consequent.length && (n = i.$compile(t.consequent, {
            record: !0,
            outer: e.outer,
            namespace: d,
            extra: o
          }), l.push(n), f.parentNode && u.inject(s.node(n), f, "before")) : t.alternate && t.alternate.length && (r = i.$compile(t.alternate, {
            record: !0,
            outer: e.outer,
            namespace: d,
            extra: o
          }), l.push(r), f.parentNode && u.inject(s.node(r), f, "before")))
        };
      return this.$watch(t.test, a, p.FORCE_INIT), l
    }, d.expression = function (t, e) {
      var n = document.createTextNode("");
      return this.$watch(t, function (t) {
        f.text(n, null == t ? "" : String(t))
      }, p.STABLE_INIT), n
    }, d.text = function (t, e) {
      var n = t.text,
        r = document.createTextNode(-1 !== n.indexOf("&") ? l.convertEntity(n) : n);
      return r
    };
    var m = /^on-(.+)$/;
    d.element = function (t, e) {
      ...
      if (m || "r-component" === v) return e.Component = m, d.component.call(this, t, e);
      "svg" === v && (h = "svg"), c && c.length && (n = this.$compile(c, {
        outer: e.outer,
        namespace: h,
        extra: p
      })), r = f.create(v, h, i), n && !l.isVoidTag(v) && f.inject(s.node(n), r), l.fixTagAST(t, a);
      var g = o.call(this, i, r, p);
      return {
        type: "element",
        group: n,
        node: function () {
        ...
        destroy: function (t) {
          t ? u.remove(r, n ? n.destroy.bind(n) : l.noop) : n && n.destroy(), g.length && g.forEach(function (t) {
            t && ("function" == typeof t.destroy ? t.destroy() : t())
          })
        }
      }
    }, d.component = function (t, e) {
      for (var n, r, i, o, a = t.attrs, u = e.Component, f = this.constructor, h = e.extra, d = e.namespace, v = this, g = {}, y = 0, E = a.length; E > y; y++) {
        var x = a[y],
          T = this._touchExpr(void 0 === x.value ? !0 : x.value);
        T.constant && (T = x.value = T.get(this)), x.value && x.value.constant === !0 && (T = T.get(this));
        var _ = x.name;
        if (!x.event) {
          var N = _.match(m);
          N && (x.event = N[1])
        }
        if ("cmpl" === x.mdf && (T = l.getCompileFn(T, this, {
            record: !0,
            namespace: d,
            extra: h,
            outer: e.outer
          ...
          i = T;
          var w = this.$get(T, !0);
          if (u = f.component(w), "function" != typeof u) throw new Error("component " + w + " has not registed!")
        }
        var b;
        (b = x.event) ? (o = o || {}, o[b] = l.handleEvent.call(this, T, b)) : (_ = x.name = l.camelCase(_), T && "expression" === T.type ? g[_] = T.get(v) : g[_] = T, "ref" === _ && null != T && (r = T), "isolate" === _ && (n = "expression" === T.type ? T.get(v) : parseInt(T === !0 ? 3 : T, 10), g.isolate = n))
      }
      var $, A = {
          data: g,
          events: o,
        ...
        S = new u(A, e);
      r && this.$refs && ($ = u.directive("ref").link, this.$on("$destroy", $.call(this, S, r))), r && v.$refs && (v.$refs[r] = S);
      for (var y = 0, E = a.length; E > y; y++) {
        var x = a[y],
          T = x.value || !0,
          _ = x.name;
        "expression" !== T.type || x.event || (T = v._touchExpr(T), 2 & n || this.$watch(T, function (t, e) {
          this.data[t] = e
        }.bind(S, _), p.SYNC), !T.set || 1 & n || S.$watch(_, v.$update.bind(v, T), p.INIT))
      }
      if (i && "expression" === i.type) {
        var O = new c;
        return O.push(S), this.$watch(i, function (t) {
          var e = f.component(t);
          if (!e) throw new Error("component " + t + " has not registed!");
          var n = new e(A),
            i = O.children.pop();
          O.push(n), n.$inject(s.last(i), "after"), i.destroy(), r && (v.$refs[r] = n)
        }, p.SYNC), O
      }
      return S
      ...
      if (i = this._touchExpr(i), o && (i = i.get(this)), s && s.link) {
        var h = {
          ...
          d = s.link.call(c, u, i, r, h);
        return "function" == typeof s.update && (l.isExpr(i) ? this.$watch(i, function (t, e) {
          s.update.call(c, u, t, e, h)
        }) : s.update.call(c, u, i, void 0, h)), "function" == typeof d && (d = {
          destroy: d
        }), d
      }
      return "expression" === i.type ? this.$watch(i, function (t, e) {
        f.attr(u, r, t)
      }, p.STABLE_INIT) : l.isBooleanAttr(r) ? f.attr(u, r, !0) : f.attr(u, r, i), e.fromElement ? void 0 : {
        destroy: function () {
          f.attr(u, r, null)
        }
      }
    ...
    function o(t, e, n) {
      for (var r = t.length, o = e.length, n = n || i, a = [], s = 0; r >= s; s++) a.push([s]);
      for (var u = 1; o >= u; u++) a[0][u] = u;
      for (var s = 1; r >= s; s++)
        for (var u = 1; o >= u; u++) n(t[s - 1], e[u - 1]) ? a[s][u] = a[s - 1][u - 1] : a[s][u] = Math.min(a[s - 1][u] + 1, a[s][u - 1] + 1);
      return a
    }
    ...
    function a(t, e, n, i) {
      ...
      for (var T = [], _ = {
          ...
          add: 0,
          removed: []
        }, u = 0; u < l.length; u++) switch (l[u] > 0 ? null === _.index && (_.index = c) : null != _.index && (T.push(_), _ = {
        index: null,
        add: 0,
        removed: []
      }), l[u]) {
        ...
        case y:
          ...
          break;
        case E:
          _.removed.push(e[s]), s++;
          break;
        case x:
          _.add++, _.removed.push(e[s]), s++, c++
      }
      return null != _.index && T.push(_), T
    }
      ...
      o = t.exports = {
        node: function (t) {
          ...
          if (t) {
            ...
            if (t = t.children || t, Array.isArray(t)) {
              ...
              n = [];
              for (var i = 0, r = t.length; r > i; i++) e = o.node(t[i]), Array.isArray(e) ? n.push.apply(n, e) : e && n.push(e);
              return n
            }
          }
        },
        ...
        destroy: function (t, e) {
          if (t) {
            ...
            if (Array.isArray(t))
              for (var n = 0, i = t.length; i > n; n++) o.destroy(t[n], e)
          }
        }
      };
    ...
    var a = n(2),
      ...
      h = "transition",
      p = "animation";
    "ontransitionend" in window || ("onwebkittransitionend" in window ? (f += " webkitTransitionEnd", h = "webkitTransition") : ("onotransitionend" in s.tNode || "Opera" === navigator.appName) && (f += " oTransitionEnd", h = "oTransition")), "onanimationend" in window || ("onwebkitanimationend" in window ? (l += " webkitAnimationEnd", p = "webkitAnimation") : "onoanimationend" in s.tNode && (l += " oAnimationEnd", p = "oAnimation")), u.inject = function (t, e, n, r) {
      if (r = r || a.noop, Array.isArray(t)) {
        for (var i = s.fragment(), o = 0, u = 0, c = t.length; c > u; u++) i.appendChild(t[u]);
        s.inject(i, e, n);
        var f = function () {
          o++, o === c && r()
        };
        for (c === o && r(), u = 0; c > u; u++) t[u].onenter ? t[u].onenter(f) : f()
      } else s.inject(t, e, n), t.onenter ? t.onenter(r) : r()
      ...
      if (t) {
        var i = 0;
        if (Array.isArray(t))
          for (var o = 0, a = t.length; a > o; o++) u.remove(t[o], n);
      ...
      o = {
          ...
          if (n._handles) {
            ...
            if (r = i[t]) {
              ...
              for (var o = 0, a = r.length; a > o; o++)
                if (e === r[o]) return r.splice(o, 1), n
            }
            return n
          }
        },
        $emit: function (t) {
          ...
          if (t) {
            ...
            if (!a) return o;
            if (e = a[r.slice(1)])
              for (var s = 0, u = e.length; u > s; s++) e[s].apply(o, n);
            if (!(e = a[r])) return o;
            for (var c = 0, u = e.length; u > c; c++) e[c].apply(o, n);
            return o
          }
        },
        $once: function (t, e) {
          var n = i.slice(arguments);
          return n.push({
            once: !0
          }), this.$on.apply(this, n)
        }
      };
    i.extend(r.prototype, o), r.mixTo = function (t) {
    ...
    var i = n(2),
      ...
      c = {
        $watch: function (t, e, n) {
          ...
          var f = i.uid("w_");
          if (Array.isArray(t)) {
            for (var l = [], h = 0, p = t.length; p > h; h++) l.push(this.$expression(t[h]).get);
            var d = [];
            s = function (t) {
              for (var e = !0, n = 0, r = l.length; r > n; n++) {
                var o = l[n](t, c);
          ...
          if (this[n.stable ? "_watchersForStable" : "_watchers"].push(v), u = this._records && this._records.length, u && this._records[u - 1].push(v), n.init === !0) {
            var m = this.$phase;
            this.$phase = "digest", this._checkSingleWatch(v), this.$phase = m
          }
          return v
        },
        $unwatch: function (t) {
    ...
    function r(t, e, n) {
      if (n)
        for (var r, i = t.target; i && i !== n;) {
          for (var o = 0, a = e.length; a > o; o++) r = e[o], r && r.element === i && r.fire(t);
          i = i.parentNode
        }
    }
    var i = n(2),
      ...
      if (n && e) {
        ...
        return u[c].push(l),
          function () {
            var t = u[c];
            if (t && t.length)
              for (var e = 0, n = t.length; n > e; e++) t[e] === l && t.splice(e, 1)
          }
      }
    })
  }, function (t, e, n) {
    function r(t, e, n) {
      ...
      var i = this,
        o = this.$watch(e, function (e) {
          for (var n = t.getElementsByTagName("option"), r = 0, i = n.length; i > r; r++)
            if (n[r].value == e) {
              t.selectedIndex = r;
              break
            }
    ...
    function i(t, e, n) {
      ...
      return void 0 === s && (s = 9 !== c.msie && "oninput" in document.createElement("input")), o ? c.on(t, "change", l) : s ? t.addEventListener("input", l) : c.on(t, "paste keyup cut change", l), void 0 === e.get(a) && t.value && e.set(a, t.value),
        function () {
          return o ? c.off(t, "change", l) : void(s ? t.removeEventListener("input", l) : c.off(t, "paste keyup cut change", l))
        }
    }
    ...
    function i(t, e) {
      ...
      for (var u, l, h, p, d, v, m = e.split(";"), g = [], y = [], E = 0, x = m.length; x > E; E++)
